<?php
	...
	class Caverphone
	{
		public static function get_caverphone_code($word)
		{
			// Convert to lowercase
			$word = strtolower($word);

			// Remove anything not in the standard alphabet (typically a-z)
			// NOTE: This may vary if the set of letters includes characters such as æ, a, or ø
			...
			// NOTE: Vowels are normally a,e,i,o,u but depending on the data might include characters such as æ, a, or ø
